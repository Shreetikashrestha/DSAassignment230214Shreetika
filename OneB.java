...
Output:
 The kth lowest combined return that can be achieved. Example 1:
...
public class OneB {
    ...
    public static void main(String[] args) {
        ...
        int[] returns2 = {3, 4};
        int k1 = 2;
        System.out.println("Output for Example 1: " + findKthLowestCombinedReturn(returns1, returns2, k1)); // Output: 8

        // Example 2
        int[] returns1_2 = {-4, -2, 0, 3};
        int[] returns2_2 = {2, 4};
        int k2 = 6;
        System.out.println("Output for Example 2: " + findKthLowestCombinedReturn(returns1_2, returns2_2, k2)); // Output: 0
    }
}
